...
open class MarkdownLink: MarkdownLinkElement {
    ...
    public init(font: MarkdownFont? = nil, color: MarkdownColor? = MarkdownLink.defaultColor, lineSpacing: CGFloat? = nil) {
        self.font = font
        self.color = color
    ...
    open func formatText(_ attributedString: NSMutableAttributedString, range: NSRange, link: String) {
        ...
        attributedString.addAttribute(NSAttributedString.Key.foregroundColor, value: MarkdownCode.defaultLinkColor, range: range)
    }
